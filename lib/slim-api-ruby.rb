...
require File.join(File.dirname(__FILE__),"slim-api/slim_query")
require File.join(File.dirname(__FILE__),"slim-api/slim_relations")
...
require File.join(File.dirname(__FILE__),"slim-api/objects/payment")
require File.join(File.dirname(__FILE__),"slim-api/objects/relation")
